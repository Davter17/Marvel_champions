...
$sql = "SELECT  
                ...
                SUM(p.Resultado= 0 && p.Dificultad=0) as nor_victoria, 
                SUM(p.Resultado= 1 && p.Dificultad=0) as nor_derrota,
                SUM(p.Resultado= 0 && p.Dificultad=1) as exp_victoria, 
                SUM(p.Resultado= 1 && p.Dificultad=1) as exp_derrota
FROM villanos v
